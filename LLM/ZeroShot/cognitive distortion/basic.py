...
# basic prompting
prompt_intro = ["请你判断以下段落是否包含如下12种（非此即彼、以偏概全、心理过滤、否定正面思考、读心术、先知错误、放大、情绪化推理、应该式、乱贴标签、罪责归己、罪责归他）认知歪曲特征，并进行多分类任务。请你用0和1标注认知歪曲特征，0表示不含有该认知歪曲特征，1表示含有该认知歪曲特征。请使用MarkDown表格形式输出分类结果。输出结果的格式如下：表头依次为id、非此即彼、以偏概全、心理过滤、否定正面思考、读心术、先知错误、放大、情绪化推理、应该式、乱贴标签、罪责归己、罪责归他。注意：请只生成MarkDown表格，其他文字不要有。"]
